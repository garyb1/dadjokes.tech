export default [
    ...
    [
      "How do programming shepherds count their flock?",
      "With lambda functions"
    ],
    [
      "What airline do developers prefer when they're in a rush?",
      "Delta."
    ],
    [
    ...
    [
      "Why was the developer's family upset with them at dinner?",
      "They forgot to git squash before going home"
    ],
    [
    ...
    [
      "What did the server say to his client who was having a bad day?",
    ...
    [
      ...
      "Nah, they don't byte. They just nibble a bit."
    ],
    [
      "How did the mafioso kill the Node server?",
      "Tie await to it and let it async."
    ],
    [
      "You know what the best thing about booleans is?",
      "Even if you are wrong, you are only off by a bit."
    ],
    [
      "Why couldn’t the user update a file on a shared server?",
      "They didn’t have the write permissions"
    ],
    [
      "What do you do when you can't understand your husband's behavior?",
      "man man"
    ],
    [
    ...
    [
      "Why do kayakers make bad programmers?",
      "Because they're afraid of waterfall."
    ],
    [
    ...
    [
      "What's a compiler developer's favorite spice?",
      "Parsley."
    ],
    [
    ...
    [
      "Why didn't the <div /> get invited to the dinner party?",
    ...
    [
      "What are the three hardest problems in computer science?",
    ...
    [
      "How does a sysadmin keep a fire going?",
    ...
    [
      "An Agent died unexpectedly. How was the crime solved?",
    ...
    [
      "Why can't SQL and NoSQL Developers date one other?",
      "Because they don't agree on relationships."
    ],
    [
      "Why is Python like the Soviet Union?",
      "Because it has no private fields"
    ],
    [
    ...
    [
      "Why shouldn't you trust Matlab developers?",
      "Because they're always plotting something."
    ],
    [
      "Why did the developer have to quit smoking?",
      "Because they couldn't afford to pay the new syntax."
    ],
    [
      "How does a programmer open a jar for their significant other?",
      "They install Java"
    ],
    [
    ...
    [
      "What is React's favorite movie genre?",
      "Suspense"
    ],
    [
    ...
    [
      "What did XHR say to AJAX when it thought it was being a Mean Girl?",
      "Stop trying to make fetch happen!"
    ],
    [
      "What was Grace Hopper's favorite car?",
      "VW Bug"
    ],
    [
    ...
    [
      ...
      "You'd think it was R, but a pirate's first love is Objectively C."
    ],
    [
      "Why did the programmer come home crying?\"",
      "His friends were always boolean him."
    ],
    [
      "Knock Knock!",
      "An async function Who's there?"
    ],
    [
    ...
    [
      "What kind of computer can hold a musical note?",
      "A Dell."
    ],
    [
      "Why did the web developer always go to the wrong hotel room?",
      "They were in room 301."
    ],
    [
    ...
    [
      "Did you hear what the clumsy cryptographer did to their password?", "Made a hash of it."
    ],
    [
      "Why are keyboards always working so hard?", "Cause they have two shifts!"
    ],
    [
      "What are clouds made of?", "Mostly linux servers."
    ],
    [
      "How does Mr. Potato Head (dev edition 0.0.1) remove his mustache?", "git stache pop"
    ],
    [
      "Why can't you use 'Soup' as your password?", "Because it isn't stroganoff"
    ],
    [
    ...
    [
      "Why was nobody given food at the developer conference?", "It was a serverless function!"
    ],
    [
      "Why did the developer cancel their dinner plans?", "They were unable to fulfil peer dependencies"
    ],
    [
      "Why did the functional programmer finally move out of their house?", "For(e) closure"
    ],
    [
      "How do JavaScript developers break up?",
      "They always promise to callback"
    ],
    [
      "Why do developers mixup Terminals and Polygraphs?",
      "Because they both can see a lie (CLI)"
    ],
    [
      "Did you hear about the programmer that was scared of IDEs?",
      "They retreated back into their shell"
    ],
    [
    ...
    [
      "Why can’t data engineers become hat makers?",
      "They can only guarantee two thirds of a CAP!"
    ],
    [
      "How did the hippie learn about database transactions?",
      "By taking ACID"
    ],
    [
    ...
    [
      "What good can come of 2989 witches casting a hex?", "None, it is always 0xBAD"
    ],
    [
      "Did you hear about the witch who was off by two when casting a hex?", "They failed to make the target DEAD and made them DEAF instead!"
    ],
    [
    ...
    [
      "Got any funny DNS jokes?", "Yeah, but it may take 24 hours to get it."
    ],
    [
      "Where do programmer dad's store their jokes?", "In a dad-a-base."
    ]
  ]